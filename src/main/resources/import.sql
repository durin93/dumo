insert into user (id, create_date, modified_date, name, password, user_id, division, oauth_id)  values(0, current_time(), current_time(), '일승철', '$2a$10$xh.bGela3WDSKZJCX.7Mru0.Rvvb.fFchK34k1dqRnb.DTMd2FwdW', 'lsc109','dumo', null);
insert into user (id, create_date, modified_date, name, password, user_id, division, oauth_id)  values(2, current_time(), current_time(), '이승철', '$2a$10$xh.bGela3WDSKZJCX.7Mru0.Rvvb.fFchK34k1dqRnb.DTMd2FwdW', 'lsc209','dumo', null);
insert into user (id, create_date, modified_date, name, password, user_id, division, oauth_id)  values(3, current_time(), current_time(), '삼승철', '$2a$10$xh.bGela3WDSKZJCX.7Mru0.Rvvb.fFchK34k1dqRnb.DTMd2FwdW', 'lsc309','dumo', null);
insert into user (id, create_date, modified_date, name, password, user_id, division, oauth_id)  values(4, current_time(), current_time(), '사승철', '$2a$10$xh.bGela3WDSKZJCX.7Mru0.Rvvb.fFchK34k1dqRnb.DTMd2FwdW', 'lsc409','dumo', null);
